...
// === Custom Metrics ===
const updateProductDuration = new metrics_1.Trend('update_product_duration');
// === Load Parameters ===
...
function default_1() {
    ...
    (0, k6_1.group)('Update Product - Valid Data', () => {
        const start = Date.now();
        const res = http_1.default.put(url, payload, params);
